...
#             self.download_from_stemwizard(filename_quad_chart, filename_quad_chart,
#                                           student_local_dir,
...
#                 full_pathname, used_cache = self.download_from_stemwizard(filedata[documenttype]['file_name'],
#                                                                           filedata[documenttype][
#                                                                                 'uploaded_file_name'],
#                                                                             f"{studentid}", local_filename)
#             elif filedata[documenttype]['uploaded_file_name'] is None:
#                 full_pathname, used_cache = self.download_from_s3(filedata[documenttype]['file_url'],
#                                                                           f"{studentid}", local_filename)
#             else:
...
#         data_cache[studentid]['files'] = self._student_file_detail(studentid,
